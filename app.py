...
class Handler(BaseHTTPRequestHandler):
    ...
    def _get_info(self, url):
        ...
        try:
            ...
            self._send(200, json.dumps({"language": info.get("language") or ""}))
...
function updateSubInfo(){
  ...
  fetch("/api/info?url="+encodeURIComponent(url)).then(r=>r.json()).then(data=>{
